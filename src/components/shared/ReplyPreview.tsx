...
function ReplyPreview(props: AugmentedPostPreview) {
  const { author, content, created_at, images, repost_parent, reply_parent } = props;
        ...
        <div className="flex justify-between w-full h-fit">
          <div className='flex h-fit flex-col'>
            <p className='flex flex-row gap-1'>
              ...
              <span className="text-[#75828d] text-base truncate">@{author.username}</span>
              <span className="text-[#75828d] text-base">·</span>
              <time className="text-[#75828d] text-base flex-1">{multiFormatDateString(created_at)}</time>
            </p>
            <p>
