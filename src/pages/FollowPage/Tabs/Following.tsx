...
import { useGetUserFollowing } from '@/react-query/queriesAndMutations';

function Following({username}: {username: string}) {
  const {data, isPending, isError, isFetchingNextPage, fetchNextPage} = useGetUserFollowing(username);
